...
declare -A SCHEMAS
SCHEMAS[TopAnime]='{ "bsonType":"object","required":["animeid","animeurl","imageurl","name","score"],"properties":{"animeid":{"bsonType":"int","minimum":1},"animeurl":{"bsonType":"string","pattern":"^https?://.*"},"imageurl":{"bsonType":"string","pattern":"^https?://.*"},"name":{"bsonType":"string","minLength":1},"englishname":{"bsonType":["string","null"]},"genres":{"bsonType":["string","null"]},"synopsis":{"bsonType":["string","null"]},"type":{"bsonType":["string","null"]},"episodes":{"bsonType":["int","null"],"minimum":0},"premiered":{"bsonType":["string","null"]},"producers":{"bsonType":["string","null"]},"studios":{"bsonType":["string","null"]},"source":{"bsonType":["string","null"]},"duration":{"bsonType":["string","null"]},"rating":{"bsonType":["string","null"]},"rank":{"bsonType":["int","null"],"minimum":0},"popularity":{"bsonType":["int","null"],"minimum":0},"favorites":{"bsonType":["int","null"],"minimum":0},"scoredby":{"bsonType":["int","null"],"minimum":0},"score":{"bsonType":"double","minimum":0,"maximum":10},"members":{"bsonType":"int","minimum":0}}}'
